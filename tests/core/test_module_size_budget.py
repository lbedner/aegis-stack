...
BUDGET: dict[str, int] = {
    ...
    "components/frontend/dashboard/modals/finance_modal/sidebar.py": 583,
    ...
    "services/ai/service.py.jinja": 1901,
    "services/finance/schemas.py": 1791,
    ...
    "components/frontend/main.py.jinja": 1406,
    ...
    "services/finance/seeds/demo_seed.py": 1022,
    "components/backend/api/ai/router.py.jinja": 991,
    "cli/payment.py.jinja": 917,
    "services/ai/providers.py.jinja": 906,
    "components/backend/api/auth/router.py.jinja": 881,
    "services/finance/domains/detection/insights/rules.py": 869,
    "services/ai/etl/llm_sync_service.py": 853,
    "components/frontend/dashboard/modals/comms_modal.py": 831,
    "components/frontend/controls/form_fields.py": 813,
    ...
    "cli/rag.py": 686,
    "services/ai/fixtures/llm_fixtures.py": 683,
    "services/load_test/worker/service.py": 678,
    "components/backend/startup/component_health.py.jinja": 676,
    ...
    "services/ai/health_context.py": 596,
    "services/finance/domains/planning/budgets/summary.py": 594,
