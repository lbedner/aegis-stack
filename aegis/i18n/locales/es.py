...
MESSAGES: dict[str, str] = {
    ...
    "add.plugins_rerendered": "Re-rendered installed plugin(s) for the new component: {names}",
    "add.specs_need_update": "These already-installed parts branch on this component and still carry their old branch: {names}",
    "add.specs_need_update_hint": "Run 'aegis update' to re-render them.",
    ...
    "update.preview_header": "What this would do to your files:",
    "update.preview_synced": "   {count} file(s) would be updated",
    "update.preview_conflicts": "   {count} file(s) would need manual resolution:",
    "update.preview_removed": "   {count} file(s) the template no longer ships would be removed",
    "update.preview_more": "      ... and {count} more",
    "update.preview_nothing": "   No file changes - the template output matches this project",
    "update.preview_unavailable": "Could not preview file changes: {error}",
    ...
    "plugins.info_files": "Archivos: {files}   Migraciones: {migrations}   CLI: {cli}",
    "plugins.cli_yes": "sí",
    "plugins.cli_no": "no",
