    ...
    "finance": ServiceSpec(
        ...
        files=FileManifest(
            primary=[
                ...
                "tests/api/test_finance_analyst_endpoints.py",
                ...
                "tests/services/test_finance_bill_editing.py",
                "tests/services/test_finance_budget.py",
                "tests/services/test_finance_query_batching.py",
                "tests/services/test_finance_pause.py",
                ...
                "tests/components/frontend/test_goals_tab.py",
                "tests/components/frontend/test_transaction_tags_ui.py",
                "tests/services/test_finance_cadences.py",
                ...
                "tests/services/test_finance_stat_details_filter.py",
                ...
                "tests/services/test_finance_stream_amount.py",
                "tests/services/test_merchant_icon.py",
                "tests/components/frontend/test_account_filter_allows.py",
                "tests/components/frontend/test_form_date_field.py",
                "tests/components/frontend/test_global_account_filter.py",
                "tests/components/frontend/test_bills_default_sort.py",
                "tests/components/frontend/test_bills_pause_ui.py",
                "tests/components/frontend/test_budget_grid.py",
                "tests/components/frontend/test_budget_outlook.py",
                "tests/components/frontend/test_diverging_line.py",
                "tests/components/frontend/test_projection_layout.py",
                "tests/components/frontend/test_category_picker_create.py",
                ...
                "tests/components/frontend/test_import_upload_wait.py",
    ...
    "documents": ServiceSpec(
        ...
        files=FileManifest(
            primary=[
                ...
                "tests/_pdf.py",
                "tests/_jobs.py",
                "tests/services/test_extraction_dispatch.py",
                "tests/services/test_documents_module_layout.py",
