...
BUDGET: dict[str, int] = {
    ...
    "components/frontend/main.py.jinja": 1416,
    ...
    "components/frontend/dashboard/cards/card_utils.py.jinja": 771,
    "core/config.py.jinja": 751,
    "cli/rag.py": 686,
    "services/ai/fixtures/llm_fixtures.py": 684,
    "services/load_test/worker/service.py": 678,
    "components/backend/startup/component_health.py.jinja": 683,
